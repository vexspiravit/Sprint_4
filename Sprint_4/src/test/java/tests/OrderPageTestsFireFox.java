...
public class OrderPageTestsFireFox {
    ...
    public OrderPageTestsFireFox(String name, String surname, String address, String metroStation, String phone) {
        this.name = name;
